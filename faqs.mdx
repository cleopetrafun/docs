...
<AccordionGroup>
  ...
  >
You can export your wallet private key using `/wallet` --> `Export Private Key` menu button. From there you can import it to wallet providers like Phantom & Solflare.
  </Accordion>
  <Accordion icon="money-bill" title="What are the fees?">
    There is a 1% fee on opening LP positions and spot trading. 

    There is no fee on closing positions or claiming LP fees.

    Rebalancing an active position charges 0.5% for 5mins schedule (fastest) and 0.15% for longer schedules.
  </Accordion>
